...
interface AchievementXPProgressProps {
  xp: number
  nextLevelXP: number
  rankStyle: {
    barColor: string
...
export const AchievementXPProgress: React.FC<AchievementXPProgressProps> = ({
  xp,
  nextLevelXP,
  rankStyle,
  isAnimating,
        ...
        <LinearProgress
          ...
          sx={{
            ...
            '& .MuiLinearProgress-bar': {
              backgroundColor: rankStyle.barColor,
              boxShadow: rankStyle.glow
                ? `0 0 4px ${rankStyle.glow}`
                : undefined,
